                            ...
                            children: [
                              ...
                              ConstrainedBox(
                                  ...
                                  child: Padding(
                                    ...
                                    child: AutoSizeText(
                                      "Any transfer made to this account will automatically top up your Faysal balance",
                                      maxLines: 3,
                                      textAlign: TextAlign.center,
                                      style: MyFaysalTheme.of(context)
                                          .text1
                              ...
                              Padding(
                                ...
                                child: const TopupWalletInfo(
                                    header: "Bank", value: "Providus"),
                              ),
                              TopupWalletInfo(
                                  header: "Account Number",
                                  value: provider.userProfile.accountNumber
                                      .toString()),
                              Padding(
                                      ...
                                      child: TopupWalletBtn(
                                        ...
                                        call: () async {
                                          await FlutterShare.share(
                                            title: 'MyFaysal Topup Details',
                                            text: '''
Account Name: ${provider.userProfile.accountname}
Account Number: ${provider.userProfile.accountNumber}
Bank name: Providus
      ''',
                                          );
                                        },
