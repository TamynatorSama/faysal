...
import 'package:faysal/pages/auth/forgot_password/new_password.dart';
...
class ForgotPasswordEmailVerification extends StatefulWidget {
  final String email;
  const ForgotPasswordEmailVerification({super.key, required this.email});
...
class _ForgotPasswordEmailVerificationState extends State<ForgotPasswordEmailVerification> {
  ...
  getToken() async {
    var token = await Login().getResetPin(widget.email, context, fToast);
    otpToken = int.parse(token);
  }
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: BoxPinWidget(
                                      pinLength: 6,
                                      obscureText: false,
                                      constrainedWidth: size.width * 0.9,
                    ...
                    NextButton(
                        ...
                        call: () async {
                          ...
                          Navigator.push(
                              ...
                              MaterialPageRoute(
                                  builder: (context) =>
                                      NewPassword(email: widget.email,token: otpToken.toString(),)));
                        },
